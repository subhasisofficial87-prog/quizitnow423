...
export default function ICSEDashboard() {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">Your ICSE dashboard</p>
        </div>

        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
          {[
            { label: 'Books', value: books.length, color: 'text-green-600' },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2">
            <div className="flex items-center justify-between mb-4">
              ...
              <a href="/ICSE" className="flex items-center gap-1.5 px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-bold rounded-xl shadow-md">
            ...
            {books.length === 0 ? (
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-10 shadow-sm border border-gray-100 dark:border-gray-700 text-center">
                ...
                <p className="text-gray-500 dark:text-gray-400">No books yet!</p>
                <a href="/ICSE" className="inline-flex items-center gap-2 mt-4 px-5 py-2.5 bg-green-600 text-white font-bold rounded-xl hover:bg-green-700">
              ...
              <div className="space-y-3">
                {books.map((book) => (
                  <div
                    key={book.id}
                    onClick={() => book.processing_status === 'completed' && router.push(`/ICSE/study/${book.id}`)}
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between gap-2">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <span className="text-xs text-gray-500 capitalize">{book.processing_status}</span>
                          </div>
                        </div>
                        <div className="flex items-center gap-2 mt-1 text-xs text-gray-500">
                          <span className="bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 px-2 py-0.5 rounded-full font-medium">{classDisplayName(book.class_level)}</span>
