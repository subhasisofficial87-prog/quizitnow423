...
export default function CBSEStudyOverview() {
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 mb-6">
          ...
          {isWeekendToday ? (
            <div className="text-center py-6">
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-1">Great work this week!</p>
            </div>
          ) : (
            <div className="grid grid-cols-2 gap-4">
              <button onClick={() => router.push(`/CBSE/study/${bookId}/lecture/${dayNumber}`)} className="flex items-center gap-3 p-4 bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-200 dark:border-blue-800 rounded-xl hover:bg-blue-100 transition-colors text-left group">
              ...
              <button onClick={() => router.push(`/CBSE/study/${bookId}/quiz/${dayNumber}`)} className="flex items-center gap-3 p-4 bg-green-50 dark:bg-green-900/20 border-2 border-green-200 dark:border-green-800 rounded-xl hover:bg-green-100 transition-colors text-left group">
